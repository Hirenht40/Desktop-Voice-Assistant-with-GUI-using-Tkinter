...
def play():
    ...
    while True:
        ...
        if 'exit' in query:
            ...
            speak('i am dancing')
            img = ImageTk.PhotoImage(Image.open('C:/Users/Bansi/Desktop/study/python/modi.gif'))  
...
frames = [PhotoImage(file='C:/Users/Bansi/Desktop/study/python/Assistant.gif',format = 'gif -index %i' %(i)) for i in range(100)]
window.title('JARVIS')
